...
# new script:
# python -m torch.distributed.launch --nproc_per_node=1 modified_eval_linear.py --results "C:\Users\tomer\researchsoftware\furniturestyle\Method1_logging.csv"   --data_path "C:\Users\tomer\Datasets" --pretrained checkpoints/swav_800ep_pretrain.pth.tar --num_classes 3 --topk 3 --lr 0.001 --wd 0.002

# Old script:
# python -m torch.distributed.launch --nproc_per_node=1 modified_eval_linear.py --data_path "C:\Users\tomer\Datasets" --pretrained checkpoints/swav_800ep_pretrain.pth.tar --num_classes 3
...
def log_results(file_path,stats={"train_loss":"NA", "train_acc":"NA","val_loss":"NA","val_acc":"NA", "val_recall1":"NA","val_recallk":"NA"}):
    ...
    with open(file_path,'a') as f:
        ...
        str_out = str_out.format(model_name="modified_eval_linear.py",
...
def retrieval(val_loader, model):
    ...
    with torch.no_grad():
        ...
        with open(args.dump_path + "/" + 'eval_linear_embeddings.npy', 'wb') as f:
    ...
    top1 = []
    topk = []
    with open(args.dump_path + "/" +'eval_linear_embeddings_image_paths.csv', 'w') as f:
